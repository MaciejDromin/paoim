...
public class CustomizedExpandableListAdapter extends BaseExpandableListAdapter {
    ...
    private Map<String, List<String>> expandableDetailList;
    ...
    public View getChildView(int lstPosn, final int expanded_ListPosition,
        ...
        TextView expandedListTextView = (TextView) convertView.findViewById(R.id.row);
    ...
    public View getGroupView(int listPosition, boolean isExpanded, View convertView, ViewGroup parent) {
        ...
        TextView listTitleTextView = (TextView) convertView.findViewById(R.id.row);
